...
SINGLE_TURN_CASES = [
    ...
    {
        "id": "normal_market_opt_out_plain_chat",
        "message": "先别看市场，我只是想普通聊一下",
        "expected_intent": "normal_chat",
        "required_reply_tokens": ["我听着", "不用立刻变成任务", "慢慢说"],
        "forbidden_reply_tokens": ["市场", "资讯", "实时源", "缓存", "事实：", "风险：", "下一步："],
        "max_reply_chars": 140,
    },
    {
        "id": "normal_codex_opt_out_plain_chat",
        "message": "不要 CODEX 线，普通聊一下",
        "expected_intent": "normal_chat",
        "required_reply_tokens": ["我听着", "不用立刻变成任务", "慢慢说"],
        "forbidden_reply_tokens": ["Codex", "CODEX", "工程", "任务状态", "事实：", "风险：", "下一步："],
        "max_reply_chars": 140,
    },
    {
        "id": "normal_current_info_opt_out_plain_chat",
        "message": "现在别查资料，先听我说",
        "expected_intent": "normal_chat",
        "required_reply_tokens": ["我听着", "不用立刻变成任务", "慢慢说"],
        "forbidden_reply_tokens": ["DeepSeek", "实时信息链", "检索", "资料", "事实：", "风险：", "下一步："],
        "max_reply_chars": 140,
    },
    {
    ...
    {
        "id": "weather_generic_no_provider",
        "message": "天气怎么样",
        "expected_intent": "weather_query",
        "required_reply_tokens": ["没接入真实天气源", "不能给实时天气"],
        "forbidden_reply_tokens": ["不编实时天气", "天气实时数据不可用", "要精确预报请看本机天气源", "DeepSeek API", "DEEPSEEK_API_KEY", "source_type"],
        "max_reply_chars": 360,
    },
    {
        "id": "weather_jinjiang",
    ...
    },
    {
        ...
        "expected_intent": "market_brief",
        "required_reply_tokens": ["不是实时直播", "实时源未接入", "60秒判断", "下一观察点"],
    ...
    },
    {
        ...
        "expected_intent": "market_brief",
        "required_reply_tokens": ["不是实时直播", "实时源未接入", "VELA 市场简报", "关键风险"],
    },
    {
    ...
    },
    {
        ...
        "required_reply_tokens": ["更新时间", "实时源未接入"],
    },
    {
...
ENTRYPOINT_ONLY_CASES = [
    {
        ...
        "required_reply_tokens": ["实时源未接入", "前台先返回状态"],
        "side_effects_allowed": False,
    },
]
